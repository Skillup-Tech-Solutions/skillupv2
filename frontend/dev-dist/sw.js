...
define(['./workbox-e67eb281'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/api\/(courses|category|careers|reviews|offers)(\/status\/Active)?$/i, new workbox.StaleWhileRevalidate({
  ...
  workbox.registerRoute(/\/api\/(login|register|verify-otp|forgot-password|reset-password)/i, new workbox.NetworkOnly(), 'GET');
